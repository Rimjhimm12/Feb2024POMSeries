...
public class RegistrationPage {
	...
	public boolean userRegister(String firstName, String lastName, String email, String telephone, String password,
		...
		eleUtil.doSendKeys(this.firstName, firstName, TimeUtil.DEFAULT_MEDIUM_TIME);//when by locator and parameter name  is same we can use this keyword to differentiate
